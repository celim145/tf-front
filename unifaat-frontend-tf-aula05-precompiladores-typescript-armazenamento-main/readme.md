# Unifaat :: Frontend :: TF :: Aula 05 - Pré-compiladores, TypeScript, Armazenamento Local <a name="unifaat-frontend-tf-aula05-precompiladores-typescript-armazenamento"></a>
